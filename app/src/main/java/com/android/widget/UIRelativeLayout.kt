...
class UIRelativeLayout @JvmOverloads constructor(
    ...
    init {
        ...
        val topLeft =
            typedArray.getDimension(R.styleable.UIRelativeLayout_android_topLeftRadius, 0f)
        val topRight =
            typedArray.getDimension(R.styleable.UIRelativeLayout_android_topRightRadius, 0f)
        val bottomLeft =
            typedArray.getDimension(R.styleable.UIRelativeLayout_android_bottomLeftRadius, 0f)
        val bottomRight =
